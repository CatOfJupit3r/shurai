...
To finish setup, run `Replace All` to replace `shurai` with name of your project.
...
- **Shared Contracts:** `@shurai/shared` with oRPC + OpenAPI generation
...
```powershell
git clone https://github.com/CatOfJupit3r/shurai.git
cd shurai
bun install
```
